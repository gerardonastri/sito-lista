...
const HeroMobile = () => {
  ...
  return (
    <div className='md:hidden h-[100vh] py-[10px]'>
        <div>
        <img src={img} className='w-[430px] h-[430px] object-cover' alt='zio sam' /> 
        ...
        <TransitionLink href="/home" className='bg-primary-dark hover:bg-[#5f1531] p-5 rounded-3xl w-fit mx-auto flex items-center justify-center mt-[30px]'><FaArrowRight className='text-white text-2xl' /></TransitionLink>
    </div>
  )
}
